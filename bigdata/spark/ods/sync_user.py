...
if __name__ == "__main__":
    ...
    record_key = "id,username"
    precombine_key = "date_joined"
    partition_path = "date_joined"
    ...
    filter_df = spark.sql(
        """select id,username,first_name as mobile,email,date_joined from t1"""
    )
    filter_df.show()
