...
if __name__ == "__main__":
    ...
    table_name = "alertmanager_alertmanager"
    hudi_table_name = "alertmanager"
    ...
    record_key = "id,project_id"
    precombine_key = "start_time"
    partition_path = "start_time"
    ...
    filter_df = spark.sql(
        """select id,project_id,receiver,job,fingerprint,status,alertname,instance,description,summary,severity,groupkey,start_time,end_time,create_time from t1"""
    )
    filter_df.show()
