...
class MigrateRepoForm(object):
    ...
    def __init__(self, auth_password=None, auth_token=None, auth_username=None, clone_addr=None, description=None, issues=None, labels=None, milestones=None, mirror=None, mirror_interval=None, private=None, pull_requests=None, releases=None, repo_name=None, service=None, uid=None, wiki=None):  # noqa: E501
